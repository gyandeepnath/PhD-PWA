...
/**
 * Split-session run: two sittings of 5 conditions for ONE participant complete all 10 conditions of an illumination block.
 ...
 */
test('split session: two sittings of 5 cover all 10 conditions', async ({ page }) => {
  const errors: string[] = [];

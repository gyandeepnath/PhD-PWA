...
async function seed() {
  ...
  await put('conditions', {
    ...
    started_at: 1, completed_at: 2, condition_duration_sec: 1, adaptation_ms_before: 0,
  });
  ...
  await put('rt_summaries', {
    ...
    misses: 2, correct_rejections: 22, hit_rate: 0.92, false_alarm_rate: 0.08, mean_rt_hits_ms: 460,

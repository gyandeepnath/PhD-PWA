...
function bundle(): SessionBundle {
  return {
    ...
    eyeMetrics: [
      ...
      { condition_id: 'B', session_id: 'S1', camera_active: false, effective_fps: null, fps_adequate_for_tiers: false, blink_rate: 0, blink_rate_full: 0, incomplete_blink_ratio: 0, blink_duration_mean_ms: null, bins: { first_half_blink_rate: null, second_half_blink_rate: null }, blink_rate_delta_from_baseline: null, blink_rate_micro: 0, blink_count_full: 0, blink_count_partial: 0, blink_count_micro: 0, blink_count_incomplete: 0, ear_baseline: null, ear_threshold_used: null, head_pitch_mean: 0, head_yaw_mean: 0, head_roll_mean: 0, head_movement_std: 0, postural_load: 0, head_stability_score: 0, off_axis_ratio: 0, gaze_calibrated: false, gaze_deviation_ratio: 0, zone_center_ratio: 0, zone_transition_count: 0, face_presence_ratio: 0, face_size_ratio: 0 },
    ],
    reactionTrials: Array.from({ length: 48 }, (_, i) => ({ trial_id: `t${i}`, condition_id: 'A', session_id: 'S1', trial_number: i, trial_category: 'signal_congruent' as const, is_signal: true, is_congruent: true, stimulus_onset_time: 0, response_time_ms: 450, accuracy: 'hit' as const, false_start: false })),
    rtSummaries: [
      { condition_id: 'A', session_id: 'S1', total_trials: 48, signal_trials: 24, hits: 22, false_alarms: 2, misses: 2, correct_rejections: 22, hit_rate: 0.92, false_alarm_rate: 0.08, mean_rt_hits_ms: 460, median_rt_hits_ms: 455, rt_sd_ms: 50, mean_rt_congruent_ms: 440, mean_rt_incongruent_ms: 480, flanker_congruency_effect_ms: 40, d_prime: 2.8, d_prime_se: 0.45, d_prime_unstable: true },
    ],
  };
}

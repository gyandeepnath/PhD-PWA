...
function bundle(): SessionBundle {
  return {
    ...
    rtSummaries: [
      { condition_id: 'A', session_id: 'S1', total_trials: 48, signal_trials: 24, hits: 22, false_alarms: 2, misses: 2, correct_rejections: 22, hit_rate: 0.92, false_alarm_rate: 0.08, error_rate: 0.1, rt_cv: 0.2, mean_rt_hits_ms: 460, median_rt_hits_ms: 455, rt_sd_ms: 50, mean_rt_congruent_ms: 440, mean_rt_incongruent_ms: 480, flanker_congruency_effect_ms: 40, d_prime: 2.8, d_prime_se: 0.45, d_prime_unstable: true },
    ],
  };
}

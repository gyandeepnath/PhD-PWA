...
function bundle(): SessionBundle {
  return {
    ...
    calibration: [
      { calibration_id: 'cal1', session_id: 'S1', is_real_calibration: true, targets_detected: 9, targets_total: 9, ear_baseline: 0.31, gaze_h_threshold: 0.12, gaze_v_threshold: 0.1 },
    ],
  };
}

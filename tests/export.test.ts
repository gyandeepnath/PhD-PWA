...
function bundle(): SessionBundle {
  return {
    ...
    eyeMetrics: [
      { condition_id: 'A', session_id: 'S1', camera_active: true, effective_fps: 28, fps_adequate_for_tiers: true, fps_adequate_for_ratio: true, observed_duration_ms: 178000, ear_sample_count: 5340, open_ear_measured: 0.29, blink_rate: 9, blink_rate_full: 8, incomplete_blink_ratio: 0.1, blink_duration_mean_ms: 150, bins: { first_half_blink_rate: 8, second_half_blink_rate: 10 }, mean_inter_blink_interval_ms: 6000, inter_blink_interval_cv: 0.3, perclos_p80: 0.05, perclos_p70: 0.08, long_closure_count: 0, long_closure_total_ms: 0, blink_rate_micro: 0, blink_count_full: 8, blink_count_micro: 0, blink_count_incomplete: 1, ear_baseline: 0.3, ear_threshold_used: 0.18, ear_complete_threshold: 0.18, head_pitch_mean: 2, head_pitch_calibrated: true, head_yaw_mean: 1, head_roll_mean: 0, head_movement_std: 1, postural_load: 1.5, head_stability_score: 0.5, off_axis_ratio: 0.1, gaze_calibrated: false, gaze_deviation_ratio: 0.2, zone_center_ratio: 0.8, zone_transition_count: 5, face_presence_ratio: 0.95, face_size_ratio: 0.2, mean_face_luma: 130, lighting_quality: 'good' },
      { condition_id: 'B', session_id: 'S1', camera_active: false, effective_fps: null, fps_adequate_for_tiers: false, fps_adequate_for_ratio: false, observed_duration_ms: null, ear_sample_count: 0, open_ear_measured: null, blink_rate: 0, blink_rate_full: 0, incomplete_blink_ratio: 0, blink_duration_mean_ms: null, bins: { first_half_blink_rate: null, second_half_blink_rate: null }, mean_inter_blink_interval_ms: null, inter_blink_interval_cv: null, perclos_p80: null, perclos_p70: null, long_closure_count: 0, long_closure_total_ms: 0, blink_rate_micro: 0, blink_count_full: 0, blink_count_micro: 0, blink_count_incomplete: 0, ear_baseline: null, ear_threshold_used: null, ear_complete_threshold: null, head_pitch_mean: 0, head_pitch_calibrated: false, head_yaw_mean: 0, head_roll_mean: 0, head_movement_std: 0, postural_load: 0, head_stability_score: 0, off_axis_ratio: 0, gaze_calibrated: false, gaze_deviation_ratio: 0, zone_center_ratio: 0, zone_transition_count: 0, face_presence_ratio: 0, face_size_ratio: 0, mean_face_luma: null, lighting_quality: null },
    ],

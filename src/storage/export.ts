...
export const CODEBOOK: Record<string, string>[] = [
  ...
  { file: '02_conditions.csv', column: 'passage_repeat_number', type: 'integer', unit: 'count', role: 'covariate', description: "How many times this participant has read this passage, counting this run. CONSTANT at 1 under the single-sitting protocol: ten passages cover ten condition-runs, so each is read exactly once and there is NO practice-effect confound to model. Above 1 only in earlier two-sitting data." },

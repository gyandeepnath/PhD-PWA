    ...
    questions: [
      {
        ...
        options: [
          "Volcanic outgassing is the principal control on atmospheric composition",
          ...
          "The oceans have absorbed all of the carbon released by human activity",
          "Photosynthesis and decomposition cancel one another exactly in an undisturbed system",
        ],
        correctIndex: 1,
      },
      {
        ...
        options: [
          "subduction zones are no longer active anywhere on Earth",
          "silicate rock has been almost entirely consumed by weathering",
          "marine organisms have stopped producing calcium carbonate",
          "it operates over hundreds of thousands of years while the disturbance was delivered within about a century",
        ],
        correctIndex: 3,
      },
      {
        ...
        options: [
          ...
          "It forms fossil fuels immediately",
        ],
        correctIndex: 2,
      },
    ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          "the history of transatlantic navigation",
          "the chemical composition of seawater",
          "the effect of tides on coastal erosion",
        ],
        correctIndex: 0,
      },
      {
        ...
        options: [
          "raise the salinity of the deep ocean",
          "reverse the direction of the Gulf Stream",
          "reduce the nutrient supply reaching surface waters and depress local fisheries",
          "eliminate the deflection caused by the rotation of the planet",
        ],
        correctIndex: 2,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "Vaccination is the only reliable protection against infectious disease",
          "Inflammation is the most important immune process",
          "The innate response is more effective than the adaptive response",
      ...
      },
      {
        ...
        options: [
          "evidence that the therapy has failed",
          "a predictable consequence of removing restraints that normally limit lymphocyte activity",
          "caused by the tumour rather than by the treatment",
          "unrelated to the mechanism by which the therapy works",
        ],
        correctIndex: 1,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "the economic value of geothermal electricity",
          "the historical record of the Krakatoa eruption",
          "what governs how violently a volcano erupts, and how such events are monitored",
          "the chemical composition of the early atmosphere",
        ],
        correctIndex: 2,
      },
      {
        ...
        options: [
          ...
          "magma and carbonated liquids have the same chemical composition",
          "volcanoes erupt only when they are physically shaken",
          "carbon dioxide is the only gas dissolved in magma",
        ],
        correctIndex: 0,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "Dreaming is the principal function of sleep",
          "Sleep is regulated by two independent systems and serves restorative functions whose disruption carries measurable costs",
          "Sleep requirements are identical across the lifespan",
          "The glymphatic system is the only reason sleep is necessary",
        ],
        correctIndex: 1,
      },
      {
        ...
        options: [
          "they are likely to exaggerate their impairment",
          "homeostatic pressure disappears after several nights",
          "circadian rhythms cease to operate under restriction",
    ...
    questions: [
      {
        ...
        options: [
          ...
          "primarily valuable as a source of timber",
          "sustained by unusually fertile soils",
          "identical in structure to temperate woodland",
        ],
        correctIndex: 0,
      },
      {
        ...
        options: [
          "rainfall declines immediately after clearance",
          "the nutrient capital held in the vegetation is transferred to ash and is quickly exhausted",
          "the underlying rock is too hard to plough",
          "decomposers are absent from cleared ground",
        ],
        correctIndex: 1,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "Earthquakes can now be predicted accurately from plate motion",
          "Continental drift was accepted as soon as it was proposed",
          "The Himalayas are the largest mountain range produced by tectonic activity",
    ...
    questions: [
      {
        ...
        options: [
          ...
          "the manufacture of optical lenses",
      ...
      },
      {
        ...
        options: [
          "red light travels more slowly than ultraviolet",
          "the eye blinks before damage can occur",
          "each individual quantum of red light carries too little energy to break a chemical bond",
          "red light is entirely absorbed by ozone",
        ],
        correctIndex: 2,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "Sound is a pressure wave, and the ear analyses its frequency, locates its source, and matches air to fluid, with distinct failures for each function",
          "Hearing loss is always caused by exposure to loud noise",
          "The decibel scale is the most important concept in acoustics",
          "Sound and light behave identically except in a vacuum",
        ],
        correctIndex: 0,
      },
      {
        ...
        options: [
          "hearing aids cannot produce sufficient volume",
          "middle-ear damage does not affect hearing",
          "amplification restores audibility but cannot repair the distorted frequency analysis",
          "hair-cell damage also destroys the tympanic membrane",
        ],
        correctIndex: 2,
      },
      {
        ...
        options: [
          "The tympanic membrane cannot heal",
          "Mammalian hair cells do not regenerate once destroyed",
          "The cochlea permanently loses its fluid",
          "The middle-ear bones fuse together",
        ],
        correctIndex: 1,
      },
    ],
    ...
    questions: [
      {
        ...
        options: [
          "the anatomy of the avian wing",
          "why ringing is superior to satellite tracking",
          "why birds migrate, how they navigate and prepare, and why the behaviour is now under pressure",
          "the effect of predators on breeding success",
        ],
        correctIndex: 2,
      },
      {
        ...
        options: [
          "they are more heavily hunted along the route",
          "their timing is set by a day-length cue that carries no information about conditions at the breeding ground",
          "they are unable to deposit sufficient fat before departure",
          "they have lost the magnetic sense entirely",
        ],
        correctIndex: 1,
      },
      {
        ...
        options: [
          "They migrate at lower altitudes",
          "They rely only on the magnetic sense",
          "They continue along their original bearing instead of computing a corrected course",
          "They postpone departure until conditions improve",
        ],
        correctIndex: 2,
      },
    ],
